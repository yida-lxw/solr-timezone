...
public class DateUtils {
    ...
    public static String parseDate(Date date) {
        ...
        return getDateFormat(null,Locale.CHINA).format(date);
    }
    ...
    public static String parseDate(Date date, String pattern) {
        SimpleDateFormat sdf = getDateFormat(null,Locale.CHINA);
     ...
     *
     * @param dateString 待转换的yyyy-MM-dd HH:mm:ss格式日期字符串
     * @return Date
     */
     ...
     * @return
     */
    public static String date2Timezone(Date srcDate, String srcTimeZone, String dstTimeZone,String dstFormat) {
        int diffTime = getDiffTimeZoneRawOffset(srcTimeZone,dstTimeZone);
        if(0 == diffTime) {
            return parseDate(srcDate,dstFormat);
        }
        long nowTime = srcDate.getTime();
        long newNowTime = nowTime - diffTime;
        Date dstDate = new Date(newNowTime);
        return parseDate(dstDate,dstFormat);
    }
    ...
    public static void main(String[] args) {
        /*System.out.println(string2UTC("yyyy-MM-dd HH:mm:ss",
                "2016-11-23 21:48:09"));
        System.out.println(parseDate(date2Timezone(new Date(),"Asia/Shanghai","ssGMT+8")));

        Date date = string2TimezoneDate("yyyy-MM-dd HH:mm:ss","2016-11-23 15:08:09:333","UTC");
        String dateStr = parseDate(date,"yyyy-MM-dd HH:mm:s:sss");
        System.out.println(dateStr);*/

        String time = "2016/11/24 23:9:01.333";
        Date date = string2TimezoneDate("yyyy/MM/dd HH:m:ss.SSS",time,"Asia/Shanghai");
        String dateStr = parseDate(date,"yyyy-MM-dd HH:mm:s:SSS");
        System.out.println(dateStr);
    }
}
